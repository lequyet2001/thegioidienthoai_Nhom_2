...
function autocomplete(inp, arr) {
    ...
    /*Thực hiện chức năng nhấn một phím trên bàn phím:*/
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Smart Phone Store</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">NHOM 2</span></p>
    </div>`);
}
